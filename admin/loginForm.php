<?php
    ...
    if (isset($_POST["login"])) {
        ...
        if ($username == "" || $password =="") {
            ...
            // mysqli_real_escape_string: để loại bỏ những kí tự có thể gây ảnh hưởng đến câu lệnh SQL.
            // $username = mysqli_real_escape_string($conn, $username);
            // $password = mysqli_real_escape_string($conn, $password);

            // $sql = "select * from admin where username = '' or 1 = 1 --;
            ...
            // "select id from emails where accesskey = ? order by date/sender "

            // du lieu co cau truc dam bao xac thuc dau vao hop le
            // if($_POST["order_by"] == "date" || $_POST["order_by"] == "sender"){
            //     $order_by = $_POST["order_by"];
            // }
            // "select id from emails where accesskey = ? order by $order_by "
